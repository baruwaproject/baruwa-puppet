...
$mailscanner_quarantine_dir     = '/var/spool/MailScanner'
...
$baruwa_mysql_repl              = 'true'
$baruwa_mysql_id                = '1'
$baruwa_mysql_peer              = '10.0.0.2'
$baruwa_mysql_repl_user         = 'replication'
$baruwa_mysql_repl_pw           = 'str0ngpw'
$baruwa_mysql_repl_increment    = '10'
$baruwa_mysql_repl_offset       = '1'
